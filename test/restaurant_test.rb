...
class RestaurantTest < Minitest::Test
  ...
  def test_menu_dish_names_are_all_caps
    restaurant2 = Restaurant.new('16:00', 'Il Posto')
  ...
  def test_announce_closing_time
    ...
    assert_equal "Fuel Cafe will be closing at 11:00 AM", restaurant1.announce_closing_time(5)
    assert_equal "Il Posto will be closing at 11:00 PM", restaurant2.announce_closing_time(7)
  end
end
